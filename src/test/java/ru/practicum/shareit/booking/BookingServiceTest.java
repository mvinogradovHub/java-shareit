...
class BookingServiceTest {
  ...
  void addBooking_whenUserNotFound_thenNotFoundException() {
    ...
    assertThrows(
        NotFoundException.class, () -> bookingService.addBooking(bookingDto, user.getId()));
  ...
  void addBooking_whenInvoke_thenValidate() {
    ...
    verify(bookingValidator, Mockito.atLeast(1))
        .checkNotYourOwnItem(Mockito.anyLong(), Mockito.any());
  }
  ...
  void getBooking_whenInvoke_thenValidate() {
    ...
    verify(bookingValidator, Mockito.atLeast(1))
        .checkItemOwnerOrAfter(Mockito.any(), Mockito.any());
  }
  ...
  void getOwnerBookings_whenStateALL_thenInvokeGetOwnerBookings() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByItemOwnerId(user.getId(), PageRequest.of(0, 10, Sort.by("start").descending()));
  }
  ...
  void getOwnerBookings_whenStateCURRENT_thenInvokeGetOwnerCurrentBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByItemOwnerIdAndStartLessThanAndEndGreaterThan(
  ...
  void getOwnerBookings_whenStateFUTURE_thenInvokeGetOwnerFutureBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByItemOwnerIdAndStartGreaterThan(Mockito.anyLong(), Mockito.any(), Mockito.any());
  }
  ...
  void getOwnerBookings_whenStatePAST_thenInvokeGetOwnerPastBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByItemOwnerIdAndEndLessThan(Mockito.anyLong(), Mockito.any(), Mockito.any());
  }
  ...
  void getOwnerBookings_whenStateREJECTED_thenInvokeGetOwnerRejectedBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .getOwnerRejectedBooking(Mockito.anyLong(), Mockito.any());
  }
  ...
  void getOwnerBookings_whenStateWAITING_thenInvokeGetOwnerWaitingBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByItemOwnerIdAndStartGreaterThanEqualAndStatus(
            Mockito.anyLong(), Mockito.any(), Mockito.any(), Mockito.any());
  }
  ...
  void getOwnerBookings_whenStateUnknown_thenBadDataException() {
    ...
    assertThrows(
        BadDataException.class, () -> bookingService.getOwnerBookings("Unknown", 1L, 0, 10));
  }
  ...
  void getBookerBookings_whenStateALL_thenInvokeFindByBookerId() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByBookerId(user.getId(), PageRequest.of(0, 10, Sort.by("start").descending()));
  }

  @Test
  void
      getBookerBookings_whenStateCURRENT_thenInvokeFindByBookerIdAndStartLessThanAndEndGreaterThan() {
    when(userRepository.findById(Mockito.anyLong())).thenReturn(Optional.of(user));

    bookingService.getBookerBookings("CURRENT", user.getId(), 0, 10);

    verify(bookingRepository, Mockito.atLeast(1))
        .findByBookerIdAndStartLessThanAndEndGreaterThan(
            Mockito.anyLong(), Mockito.any(), Mockito.any(), Mockito.any());
  }
  ...
  void getBookerBookings_whenStateFUTURE_thenInvokeFindByBookerIdAndStartGreaterThan() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByBookerIdAndStartGreaterThan(Mockito.anyLong(), Mockito.any(), Mockito.any());
  }
  ...
  void getBookerBookings_whenStatePAST_thenInvokeFindByBookerIdAndEndLessThan() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .findByBookerIdAndEndLessThan(Mockito.anyLong(), Mockito.any(), Mockito.any());
  }
  ...
  void getBookerBookings_whenStateREJECTED_thenInvokeGetBookerRejectedBooking() {
    ...
    verify(bookingRepository, Mockito.atLeast(1))
        .getBookerRejectedBooking(Mockito.anyLong(), Mockito.any());
  }

  @Test
  void
      getBookerBookings_whenStateWAITING_thenInvokeFindByBookerIdAndStartGreaterThanEqualAndStatusIs() {
    when(userRepository.findById(Mockito.anyLong())).thenReturn(Optional.of(user));

    bookingService.getBookerBookings("WAITING", user.getId(), 0, 10);

    verify(bookingRepository, Mockito.atLeast(1))
        .findByBookerIdAndStartGreaterThanEqualAndStatusIs(
            Mockito.anyLong(), Mockito.any(), Mockito.any(), Mockito.any());
  }
  ...
  void getBookerBookings_whenStateUnknown_thenBadDataException() {
    ...
    assertThrows(
        BadDataException.class, () -> bookingService.getBookerBookings("Unknown", 1L, 0, 10));
  }
