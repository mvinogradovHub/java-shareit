...
public class ItemRequestController {
  ...
  public ItemRequestDto addItemRequest(
    ...
    log.info(
        "Received request to POST /requests with RequestHeader X-Sharer-User-Id = {} and body: {}",
        userId,
        itemRequestDto);
  ...
  public ItemRequestDto getItemRequest(
    ...
    log.info(
        "Received request to GET /requests/{} with RequestHeader X-Sharer-User-Id = {}",
        requestId,
        userId);
  ...
  @GetMapping("/all")
  public List<ItemRequestDto> getItemPageableRequests(
      @RequestHeader("X-Sharer-User-Id") Long userId,
      @RequestParam(defaultValue = "0") Integer from,
      @RequestParam(defaultValue = "10") Integer size) {
    log.info(
        "Received request to GET /requests/all?from={}&size={} with RequestHeader X-Sharer-User-Id = {}",
        from,
        size,
        userId);
